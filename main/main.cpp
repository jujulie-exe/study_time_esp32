...
void lcd_init() {
    ...
    esp_lcd_panel_mirror(panel_handle, false, true); // adjust orientation if upside down
...
extern "C" void app_main(void) {
  ...
  ScansionBLE radar;
  radar.init();
  xTaskCreatePinnedToCore(task_scan_ble, "task_scan_ble", 4096, &radar, 1, NULL, 1);
